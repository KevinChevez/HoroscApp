...
import com.example.horoscapp.ui.lucky.model.LuckyModel
...
class RandomCardsProvider @Inject constructor() {
    fun getLucky(): LuckyModel = when (Random.nextInt(0, 33)) {
        ...
        27 -> LuckyModel(R.drawable.card_king_cups, R.string.app_name)
        28 -> LuckyModel(R.drawable.card_king_swords, R.string.app_name)
        29 -> LuckyModel(R.drawable.card_king_wands, R.string.app_name)
        30 -> LuckyModel(R.drawable.card_lovers, R.string.app_name)
        31 -> LuckyModel(R.drawable.card_page_wands, R.string.app_name)
        32 -> LuckyModel(R.drawable.card_queen_cup, R.string.app_name)
        33 -> LuckyModel(R.drawable.card_queen_pentacles, R.string.app_name)
